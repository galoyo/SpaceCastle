...
class MobExplode extends EnemyParentClass 
{
	...
	/*******************************************************************************************************
	 * how much additional speed is added to velocity.y
	 */
	private var raSpeed:Int;
			
	/*******************************************************************************************************
	 * Random distance from player. Used with other vars to make this spike fall if spike is within the x range of the player.
	 */
	private var ra:Int;
	
	/*******************************************************************************************************
	 * Used along with another var to increase the direction of this mob as this mob falls to the ground.
	 */
	private var ra2:Int;
	...
	/*******************************************************************************************************
	 * This var is used to delay the reset of this mob.
	 */
	...
	/*******************************************************************************************************
	 * This var is used to continue the movement of this mob towards the player.
	 */
	private var _fixedDirection:Int = 0;
